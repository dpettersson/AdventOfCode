...
# unpack something that washed ashore. It's quite cold out, so you decide to risk creating a paradox by asking
# them for directions.
#
# "Oh, are you the search party?" Somehow,
# you can understand whatever Elves from the year 1018 speak;
...
# Then, even though F was available earlier, steps B and D are now also available, a
# nd B is the first alphabetically of the three.
...
# "The sun will set soon; it'll go faster if we work together." Now, you need to account for multiple people working
# on steps simultaneously. If multiple steps are available, workers should still begin them in alphabetical order.
#
