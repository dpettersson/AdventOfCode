...
def day_two_part_one(data):
    ...
    print("End coordinate is: \nX " + str(x) + "\nY " + str(y))
    print("Combined pos: " + str(x * y))
    return x * y


# assert day_two_part_one(test_data) == 150
#day_two_part_one(read_input())
...
#assert day_two_part_two(test_data) == 900

day_two_part_two(read_input())
